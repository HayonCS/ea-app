...
//   const userPicture = useUserPicture(props.userInfo?.employeeId ?? props.employeeId ?? "");
//   const userInfoHook = useUserInformation(props.userInfo ? "" : props.employeeId ?? "")
...
//     setPictureUrl(
//       `https://lumen.gentex.com/InnovatorImage/images/customer/employee/0000${props.userInfo?.employeeId ?? props.employeeId ?? ""}.jpg`
//     );
//   };
...
//     } else if (userInfoHook !== "Error" && userInfoHook !== "Loading")
//   }, [props, userInfoHook]);
