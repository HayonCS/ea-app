export default [
  ...
  "Please wait for the satellite to move into position",
  "keep calm and npm install",
  "The bits are flowing slowly today",
  "Dig on the 'X' for buried treasure... ARRRRR!",
  ...
  "Chuck Norris never does a git push. The repo pulls a Chuck Norris.",
  ...
  "Please wait while the intern refills your coffee.",
  "A different error message? Finally, some progress!",
  "Hold on while we git things together...sorry",
  "Please hold on as we reheat our coffee",
  "Kindly hold on as we convert this bug into a feature...",
  "Kindly hold on as our intern learns how to quit vim...",
  "Winter is coming...",
  ...
  "Waiting while Daenerys says all her titles...",
  "Feel free to spin in your chair",
  "What the what?",
  "format C: ...",
  "Forget you saw that password I just typed into Teams...",
  "What's under there?",
  ...
  "Coffee at Starbucks, tommorow at 10A.M. - don't be late!",
  "Work, work...",
  ...
  "Everyone is at a GTM cookout you weren't invited to.",
  "Turn screen 45 degrees for optimal results",
];
