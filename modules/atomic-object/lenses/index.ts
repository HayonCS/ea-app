...
const _generalUpdater = makeUpdater();
...
export namespace Prism {
  export function of<T, V>(spec: IPrism<T, V>): Prism<T, V> {
    const func = <Prism<T, V>>function (o: T) {
      return spec.get(o);
    };
  ...
  export function comp(...prisms: Prismish<any, any>[]): Prism<any, any> {
    ...
    return Prism.of({
      get: (o: any) =>
        prisms.reduce((p, l) => (p === undefined ? p : l.get(p)), o),
