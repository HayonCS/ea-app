...
const rawAzureAdConfig = config.get<IOIDCStrategyOptionWithoutRequest>(
  "auth.azureAD"
);
                    ...
                    (managerResult) => {
                      if (managerResult) {
                        const updatedUserInfo = {
                          ...
                          FirstName: mesUserResult.firstName,
                          LastName: mesUserResult.lastName,
                          UserName: mesUserResult.username,
                          Email: mesUserResult.emailAddress,
                          CellPhone: employeeInfoResult.cellPhone,
                          WorkPhone: employeeInfoResult.workPhone,
                          Location: employeeInfoResult.location,
                          LocationID: employeeInfoResult.locationId,
                          Shift: employeeInfoResult.shift,
                          JobTitle: employeeInfoResult.jobTitle,
                          ManagerEmployeeNumber:
                            employeeInfoResult.managerEmployeeNumber,
                          ErphrLocation: {
                            LocationID:
                              employeeInfoResult.erphrLocation.locationId,
                            LocationCode:
                              employeeInfoResult.erphrLocation.locationCode,
                            Description:
                              employeeInfoResult.erphrLocation.description,
                            InventoryOrgCode:
                              employeeInfoResult.erphrLocation.inventoryOrgCode,
                            InventoryOrgID:
                              employeeInfoResult.erphrLocation.inventoryOrgId,
                          },
                          IsManager: employeeInfoResult.isManager,
                          Status: employeeInfoResult.status,
                          SalaryType: employeeInfoResult.salaryType,
                          EmployeeType: employeeInfoResult.employeeType,
                          PersonType: employeeInfoResult.personType,
                          PayGroup: employeeInfoResult.payGroup,
                          PreferredLocale: employeeInfoResult.preferredLocale,
                          PreferredDisplayLang:
                            employeeInfoResult.preferredDisplayLang,
                          PreferredCurrency:
                            employeeInfoResult.preferredCurrency,
                          PrimaryTimezone: employeeInfoResult.primaryTimezone,
                          FullTime: employeeInfoResult.fullTime,
                          PartTime: employeeInfoResult.partTime,
                        };
            ...
            ctxProd.mesSecurity
              ...
              .then(
                (managerResult) => {
                  if (managerResult) {
                    const updatedUserInfo = {
                      EmployeeNumber: employeeInfoResult.employeeNumber,
                      FirstName: employeeInfoResult.firstName,
                      LastName: employeeInfoResult.lastName,
                      UserName: employeeInfoResult.email.split("@")[0],
                      Email: employeeInfoResult.email,
                      CellPhone: employeeInfoResult.cellPhone,
                      WorkPhone: employeeInfoResult.workPhone,
                      Location: employeeInfoResult.location,
                      LocationID: employeeInfoResult.locationId,
                      ...
                      ManagerEmployeeNumber:
                        employeeInfoResult.managerEmployeeNumber,
                      ErphrLocation: {
                        LocationID: employeeInfoResult.erphrLocation.locationId,
                        LocationCode:
                          employeeInfoResult.erphrLocation.locationCode,
                        Description:
                          employeeInfoResult.erphrLocation.description,
                      ...
                      PreferredDisplayLang:
                        employeeInfoResult.preferredDisplayLang,
                      PreferredCurrency: employeeInfoResult.preferredCurrency,
                      PrimaryTimezone: employeeInfoResult.primaryTimezone,
                      FullTime: employeeInfoResult.fullTime,
                      PartTime: employeeInfoResult.partTime,
                    };
